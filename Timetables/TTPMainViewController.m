...
- (void)viewDidLoad
{
	...
	NSString *timetableURLString = [NSString stringWithFormat:@"http://api.ssutt.org:8080/2/department/%@/group/%@", self.selectedDepartment.tag,
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    NSError *error;
  //  self.timetable = [self.parser parseGroups:self.responseData error:error];
